        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>123 Street, UB, mongolia</small>
                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    ...
                                    <a href="{{route('contact')}}" class="btn btn-primary py-sm-3 px-sm-5">Xолбоо барих</a>
                                    <a href="{{route('main.test')}}" class="btn btn-light py-sm-3 px-sm-5 ms-3">Бөглөх тестүүд</a>
                                </div>
                            </div>
                        </div>
                    </div>
