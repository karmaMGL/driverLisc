                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Total incorrect Answered</p>
                            <h2 class="text-white"> {{$userDataNumber['incorrect']}}<span class="h5">.00</span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Total correct answer</p>
                            <h2 class="text-white"> {{$userDataNumber['correct']}}.<span class="h5">00</span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Total exam taken</p>
                            <h2 class="text-white"> {{$userDataNumber['testsTaken']}}<span class="h5">.00</span>
                            </h2>
                          </div>
...
<script>
    ...
    // Set dimensions and margins for the chart
    var width = screen.width/100*90, height = 400, margin = 50;
        ...
        tooltip.style("opacity", 0);
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Нийт шалгалтанд тэнцсэн</p>
                      ...
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Нийт шалгалтанд тэнцээгүй</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
            ...
            <div class="row">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="dashboardAssets/assets/images/faces/face10.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="dashboardAssets/assets/images/faces/face11.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="dashboardAssets/assets/images/faces/face13.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="dashboardAssets/assets/images/faces/face16.jpg" alt="image" />
                                <div class="table-user-name ml-3">
              ...
              <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="card-title font-weight-medium"> Шалгалтын график </div>
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="dashboardAssets/assets/images/dashboard/img_3.jpg" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="dashboardAssets/assets/images/dashboard/img_1.jpg" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="dashboardAssets/assets/images/dashboard/img_2.jpg" alt="" />
                      <div class="pt-2">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="dashboardAssets/assets/images/faces/face22.jpg" alt="" />
                          </div>
                      ...
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboardAssets/assets/images/faces/face25.jpg" alt="" />
                          </div>
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboardAssets/assets/images/faces/face5.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="dashboardAssets/assets/images/faces/face2.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="dashboardAssets/assets/images/dashboard/img_4.jpg" alt="" />
                          <div class="pl-2">
                    ...
                    <div class="row py-3 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="dashboardAssets/assets/images/dashboard/img_5.jpg" alt="" />
                          <div class="pl-2">
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="dashboardAssets/assets/images/faces/face1.jpg" alt="" />
                              <img class="ml-1" src="dashboardAssets/assets/images/faces/face10.jpg" alt="" />
                              <img class="ml-1" src="dashboardAssets/assets/images/faces/face14.jpg" alt="" />
                            </span>
                          </span>
                        </p>
                      </li>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboardAssets/assets/images/faces/face2.jpg" alt="" />
                            </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboardAssets/assets/images/faces/face3.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="dashboardAssets/assets/images/faces/face11.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboardAssets/assets/images/browser-logo/opera-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboardAssets/assets/images/browser-logo/safari-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboardAssets/assets/images/browser-logo/chrome-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="dashboardAssets/assets/images/browser-logo/firefox-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="mr-2" src="dashboardAssets/assets/images/browser-logo/explorer-logo.png" alt="" />
