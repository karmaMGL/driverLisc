...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <link href="{{asset('questionOverview/bootstrap.min.css')}}" rel="stylesheet">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="createExamModalLabel">Create New Exam</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form id="createExamForm" action="{{ route('createExam.func') }}" method="POST">
                @csrf
                <div class="mb-3">
                  <label for="examTitle" class="form-label">Exam Title</label>
                  <input type="text" class="form-control" id="examTitle" name="name" placeholder="Enter exam title" required>
                </div>
          ...
          @foreach ($exams as $one)
            <div class="col">
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  <p class="card-text">{{$one->id}}. {{ $one->name}}.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">View</button>
                      <a href="{{route('getSections',$one->id)}}"><button type="button" class="btn btn-sm btn-outline-secondary">Edit</button></a>
